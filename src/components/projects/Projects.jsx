...
import { ulbakuya } from "../../config/cloudinary"
...
function Projects({ proyRef }) {
  return (
    <section
      ...
      {/* title */}
      <h1 className="text-2xl md:text-3xl font-bold mb-10 bg-gradient-to-r from-violet-400 to-purple-600 bg-clip-text text-transparent">
        Proyectos
      </h1>
